...
public class Login {
	...
	public void Demo1() throws InterruptedException {
		...
		Thread.sleep(2000);
		WebElement buttonLogin = driver.findElement(By.xpath("//header/div[1]/div[1]/div[1]/div[1]/p[1]/a[1]"));
		buttonLogin.click();
		Thread.sleep(2000);
		WebElement checkLoginPagElement = driver.findElement(By.xpath("//h5[@id='loginModalTitle']"));
		if (checkLoginPagElement.getText().equals("Hey, Welcome back!")) {
			WebElement textboxUserElement = driver.findElement(
					By.xpath("//body/div[@id='loginModal']/div[1]/div[1]/div[2]/form[1]/div[1]/div[1]/input[1]"));
			textboxUserElement.sendKeys("quangtruongdz9009@gmail.com");
			WebElement textboxPasswrodElement = driver.findElement(
					By.xpath("//body/div[@id='loginModal']/div[1]/div[1]/div[2]/form[1]/div[2]/div[1]/input[1]"));
			textboxPasswrodElement.sendKeys("quangtruongdz9009@gmail.com");

			WebElement checkKeepmElement = driver
					.findElement(By.xpath("//label[contains(text(),'Keep me signed in')]"));
			checkKeepmElement.click();
			Thread.sleep(1000);
			WebElement buttonLoginAccoutElement = driver.findElement(
					By.xpath("//body/div[@id='loginModal']/div[1]/div[1]/div[2]/form[1]/div[4]/button[1]"));
			buttonLoginAccoutElement.click();
		}
	...
	public void Demo2() throws InterruptedException {
		...
		WebElement clickcity = driver
				.findElement(By.xpath("//body/section[2]/div[1]/div[1]/div[1]/div[3]/div[2]/form[1]/div[5]/div[1]"));
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", clickcity);
		Thread.sleep(3000);
		WebElement clickcityyy = driver.findElement(By.xpath(
				"//body/section[2]/div[1]/div[1]/div[1]/div[3]/div[2]/form[1]/div[8]/div[1]/div[1]/div[1]/a[1]"));
		clickcityyy.click();

		WebElement textsearchElement = driver.findElement(By.xpath(
				"//body/section[2]/div[1]/div[1]/div[1]/div[3]/div[2]/form[1]/div[8]/div[1]/div[1]/div[1]/div[1]/div[1]/input[1]"));
...
//			}
		...
		WebElement phonenumElement = driver.findElement(
				By.xpath("//body/section[2]/div[1]/div[1]/div[1]/div[3]/div[2]/form[1]/div[9]/div[1]/div[1]/input[1]"));
		phonenumElement.sendKeys("0812341234");

//			Pricey Details

//			1. Price Range
		WebElement priceyrace = driver.findElement(By.xpath(
				"//body/section[2]/div[1]/div[1]/div[1]/div[4]/div[2]/form[1]/div[1]/div[1]/div[1]/div[1]/a[1]"));
		...
		WebElement searchpriceyElement = driver.findElement(By.xpath(
				"//body/section[2]/div[1]/div[1]/div[1]/div[4]/div[2]/form[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/input[1]"));
...
//			2. Get minn pricey		
		WebElement getpriceyMiinnElement = driver.findElement(
				By.xpath("//body/section[2]/div[1]/div[1]/div[1]/div[4]/div[2]/form[1]/div[2]/div[1]/div[1]/input[1]"));
		getpriceyMiinnElement.sendKeys("100000");

//			3. Get max pricey		
		WebElement getpriceyMaxElement = driver.findElement(
				By.xpath("//body/section[2]/div[1]/div[1]/div[1]/div[4]/div[2]/form[1]/div[3]/div[1]/div[1]/input[1]"));
...
//				4.1 time openn Monday 
		...
		WebElement searchTimeMonnndayElement = driver
				.findElement(By.xpath("//tbody/tr[1]/td[2]/div[1]/div[1]/div[1]/input[1]"));
...
//			4.2 time close Monday 
		...
		WebElement searchTimeMonnndaycloseElement = driver
				.findElement(By.xpath("//tbody/tr[1]/td[3]/div[1]/div[1]/div[1]/input[1]"));
